...
for root, dirs, files in os.walk(caminho):
    for file_ in files:
        ...
        # ou eses dois metodos mostra
        # propriedades do arquivo como: tamanho, data de criação, etc
        stats = os.stat(caminho_completo_arquivo)
        tamanho = stats.st_size  # outro metados: st_time, etc

        the_counter = next(counter)
        print(the_counter, caminho_completo_arquivo, formata_tamanho(tamanho))
