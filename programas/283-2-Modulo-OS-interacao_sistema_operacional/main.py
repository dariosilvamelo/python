...
# mostra o arquivo e extenção
nome_arquivo, extensao_arquivo = os.path.splitext(arquivo)
print(nome_arquivo, extensao_arquivo)

# mostra se o diretorio do existe
print(os.path.exists('/Users/luizotavio/Desktop/curso-python-rep'))

print('============================================')
# mostra o caminho absoluto deste arquivo
caminho2 = os.path.abspath('.')
caminho2 += '\\283-2-Modulo-OS-interacao_sistema_operacional\\main.py'
print(caminho2)
diretorio2, arquivo2 = os.path.split(caminho2)
print(os.path.basename(caminho2))
print(os.path.basename(diretorio2))
